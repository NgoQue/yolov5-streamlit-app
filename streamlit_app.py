...
#------------------------------------------------------------------------------------------------------------------------------------------------------#
        if material_shell is not None and material_core is not None:
            ...
            with col1:
                ...
                ax.plot( wavelengths,column_0,'b',  label='qext', marker='s', markersize=3, markevery=10)
                ...
                ax.plot( wavelengths,column_0,'g', label='qabs', marker='^', markersize=5, markevery=11)
