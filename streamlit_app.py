...
st.write('We estimate the size of single-particle materials or spherical core-shell materials using the YOLOv5 model in computer vision, then calculate the spectrum absorption, scattering, extinction corresponding to the size of the material, and compute the photothermal heating of the material at 808-nm laser irradiation at specific concentrations.
...
#------------------------------------------------------------------------------------------------------------------------------------------------------#
        if material_shell is not None and material_core is not None:
            ...
            if not np.isnan(D_shell) and np.isnan(D_core):
